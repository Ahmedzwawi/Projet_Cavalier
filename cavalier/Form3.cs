...
namespace Cavalier
{
    public partial class Form3 : Form
    {
        ...
        private void Form3_Load(object sender, EventArgs e)
        {
            ...
            button2.Text = "Cocher une case pour commencer";
            
            label1.Visible = false;
            button4.Text = "REJOUEZ ?";
                ...
                if (isValid == 0)
                {
                    ...
                    foreach (Button buttonToEnable in grille)     
                    {
                        if (helpButton == Convert.ToInt32(buttonToEnable.Name))
                        {
                            ...
                            buttonToEnable.BackColor = Color.Yellow;
                            finDeJeu = false;
                        }
                    }
                }
        ...
        private void endTheGame(int nbButtonClicked)
        {
            ...
            {
                label2.Text = " Excellent !! VOUS AVEZ  GAGNE !";
            ...
            else
            {
                ...
                label2.Text = "Vous avez obtenu " + nbButtonClicked + " points";
                button4.Visible = true;
                label2.Visible = true;
            }
        ...
        {
            var reponse = MessageBox.Show("Voulez vous sortir?", "Sortie", MessageBoxButtons.YesNo, MessageBoxIcon.Stop);
            if (reponse == DialogResult.Yes)
            {
                Application.Exit();
            }
